    ...
    <div className="bg-slate-900 text-slate-300">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-slate-900/80 backdrop-blur-sm">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            {user ? (
              <>
                <button onClick={() => navigate('/profile')} className="text-sm text-slate-300 hover:text-white">Profile</button>
              ...
              <>
                <button onClick={() => navigate('/signup')} className="text-sm bg-blue-600 hover:bg-blue-500 text-white font-semibold px-4 py-2 rounded-lg transition-colors">Sign Up</button>
                <button onClick={() => navigate('/login')} className="text-sm text-slate-300 hover:text-white">Login</button>
              </>
            )}
          </div>
        </div>
      ...
      <section className="min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url('https://picsum.photos/seed/oceanbg/1920/1080')" }}>
        ...
        <div className="relative z-10 text-center text-white p-4">
          ...
          <button onClick={() => navigate('/map')} className="bg-white/10 border border-white/20 hover:bg-white/20 text-white font-semibold px-8 py-3 rounded-lg flex items-center mx-auto space-x-2 backdrop-blur-sm">
            <span>Dive In</span>
